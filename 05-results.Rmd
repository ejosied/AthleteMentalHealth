...
MH_subset <- dplyr::select(df, CESD01, CESD02, CESD03, CESD04, CESD05, CESD06, CESD07, CESD08, CESD09, CESD10)
...
MH_summary <- likert(MH_subset)

# use function likert() to plot survey data
plot(likert(MH_subset), main = "Mental Health Responses")
