...
* We did not encounter any issues with our data. 
...
Click the link below for a larger view of the interactive component through VizHub:
https://vizhub.com/ejosied/523eafd90aa247c4923c1c0d3ff45843
...
These sport-by-sport comparisons give us quick tests of intuition, but by engaging with the interaction for a longer amount of time, you start to get a sense of how all of the sports are related to each other. We encourage you to ask yourself questions about the comparisons you saw. Did you notice any trends? How did the scores differ between team and individual sports? Between traditionally male- and female-dominated sports? Did any of the results surprise you? How will these insights change your perspective moving forward?
...
We came into this project with an idea of how certain sports may be correlated with mental health outcomes. In our analysis, however, we found that these correlations are not as strong as we had thought. For example, we had expected that the critical nature of artistic or performative sports like dance and gymnastics would result in more negative mental health responses among participants compared to goal-oriented sports like baseball or soccer, but the data shows that the type of sport did not have a strong connection to the mental health responses. In fact, the most noticeable difference in any calculated score was not found while faceting by sport, but by gender; the male athletes surveyed generally admitted to more risky behavior than the female athletes.

Rather than be disappointed that we did not find strong correlations between sports and mental health, we can instead take a moment to recognize how personal experiences and biases may lead us to make predictions that do not align with the facts. In addition, we also admit that not all athletes within a sport have the same mental health status, motivation for participation, risk tolerance, or perspectives on success - humans are diverse and faceted themselves! 


## Limitations

The initial survey contained nearly six hundred responses from each participant, so there was a lot of information; we had to make some decisions to decide which information to include and exclude in hopes of best answering our questions. As a result, we may have omitted responses that could have led to interesting insights if we had only asked questions targeting those variables.
...
Additionally, this dataset only represents college students, therefore this cannot be extrapolated to describe professional athletes, hobbyists, or amateur athletes outside of college. 
